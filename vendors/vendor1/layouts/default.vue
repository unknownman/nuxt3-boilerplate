<template>
    <header>
        <nav class="bg-white shadow-lg shadow-gray-100 border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
    ...
    <main class="min-h-70vh pa-10">
        <slot />
    </main>
    <footer class="shadow-lg   p-4 bg-warmGray-1  md:p-8 lg:p-10 dark:bg-gray-800">
        <div class="mx-auto max-w-screen-xl text-center">
            <a href="#" class="flex justify-center items-center text-2xl font-semibold text-gray-900 dark:text-white">
                <logo></logo> Title
            </a>
            <p class="my-6 text-gray-500 dark:text-gray-400">Open-source library to extend ssr App.</p>
            ...
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2021-2022 <a href="#"
                    class="hover:underline">title</a>. All Rights Reserved.</span>
        </div>
    </footer>
</template>