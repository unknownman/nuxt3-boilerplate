<template>
    <div v-if="isOpen" id="drawer-navigation"
        class="fixed top-0 left-0 border-r-1 z-40 h-screen p-4 overflow-y-auto bg-white w-80 dark:bg-gray-800"
        tabindex="-1">
        ...
        <button type="button" data-drawer-dismiss="drawer-navigation" aria-controls="drawer-navigation"
            ...
            <span class="sr-only" @click="onClose">Close menu</span>
        </button>
