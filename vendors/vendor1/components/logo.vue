<template>
    <svg id="logo-58" h-11 viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path class="stroke"
            ...
            stroke="#231F20" stroke-width="0.5" stroke-miterlimit="10"></path>
        <path class="stroke" d="M25 15.01H19.23L13.47 25L19.23 34.99H25" stroke="#231F20" stroke-width="0.5"
            stroke-miterlimit="10"></path>
        <path class="stroke" d="M8.28001 25L5.70001 29.48" stroke="#231F20" stroke-width="0.5" stroke-miterlimit="10">
        </path>
        <path class="stroke" d="M44.3 29.48L41.72 25" stroke="#231F20" stroke-width="0.5" stroke-miterlimit="10"></path>
        <path class="stroke" d="M25 43.94H35.94L39.14 38.39L41.71 33.94L39.14 29.48" stroke="#231F20" stroke-width="0.5"
            stroke-miterlimit="10"></path>
        <path class="stroke"
        ...
        <path class="stroke"
            ...
            stroke="#231F20" stroke-width="0.5" stroke-miterlimit="10"></path>
        <path class="stroke" d="M25 15.01H30.77L36.53 25L30.77 34.99H25" stroke="#231F20" stroke-width="0.5"
            stroke-miterlimit="10"></path>
